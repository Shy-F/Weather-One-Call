...
var weatherNow = document.querySelector("#current-weather-container");
var citySearch = document.querySelector("#searched-city");
var forecastTitle = document.querySelector("#forecast");
var forecastNow = document.querySelector("#fiveday-container");
var pastSearch = document.querySelector("#past-search-buttons");
...
var getCityWeather = function(city){
    var apiKey = "d42e3cdc10419abb64bebe82076722b9"
...
var displayWeather = function(weather, searchCity){
   ...
   weatherNow.appendChild(temperatureEl);
...
var displayUvIndex = function(index){
    ...
    weatherNow.appendChild(uvIndexEl);
}
...
var display5Day = function(weather){
    ...
    var forecast = weather.list;
       ...
       forecastEl.appendChild(forecastHumEl);
        ...
        forecastNow.appendChild(forecastEl);
    }
